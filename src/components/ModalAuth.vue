<template>
<button @click="showModal = true" class="block lg:flex items-center relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-slate-400 hover:text-black py-2 px-3 lg:w-16 lg:justify-center">
...
<template #body>
    <form v-if="type == 'login'" class="w-full" @submit.prevent="login">
        ...
        <button class="align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none px-4 py-2 rounded-lg text-sm text-white bg-purple-600 border border-transparent active:bg-purple-600 hover:bg-purple-700 focus:shadow-outline-purple w-full mt-4" type="submit">
        {{ $t('auth.signin') }}
        </button>
        <p class="mt-4">
        <router-link class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" to="/restore">{{ $t('auth.forgot_your_password') }}</router-link>
        </p>
        <p class="mt-1">
        <a @click="type = 'register'" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="#">{{ $t('auth.signup') }}</a>
        </p>
    </form>
    <form v-if="type == 'register'" class="w-full" @submit.prevent="login">
        ...
        <label class="block text-sm text-gray-700 dark:text-gray-400 mt-4">
            ...
            <input class="block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:shadow-outline-green dark:focus:shadow-outline-green mt-1" type="text" placeholder="Jane" v-model="form_add_user.firstname" required>
        </label>    
        </div>  
        <div class="mt-4">
        <label class="block text-sm text-gray-700 dark:text-gray-400 mt-4">
            <span>{{ $t('auth.last_name') }}</span>
            <input class="block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:shadow-outline-green dark:focus:shadow-outline-green mt-1" type="text" placeholder="Doe" v-model="form_add_user.lastname" required>
        </label>    
        </div>                
        <div class="mt-4">
        <label class="block text-sm text-gray-700 dark:text-gray-400">
            <span>{{ $t('auth.birthday') }}</span>
            <input class="block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 focus:border-purple-400 dark:border-gray-600 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700 mt-1" type="date" v-model="form_add_user.birthday" required>
        </label>
        </div>
        <div class="mt-4">
        ...
        <div class="mt-2">
            ...
            <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray focus:border-purple-400 dark:border-gray-600 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700" type="radio" name="sex" value="sex1" v-model="form_add_user.sex1" required>
            <span class="ml-2">{{ $t('auth.male') }}</span>
            </label>
            <label class="block text-sm text-gray-700 dark:text-gray-400 inline-flex items-center ml-6">
            <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray focus:border-purple-400 dark:border-gray-600 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700" type="radio" name="sex" value="sex2" v-model="form_add_user.sex2" required>
        ...
        <label class="block text-sm text-gray-700 dark:text-gray-400">
        <span>{{ $t('auth.email') }}</span>
        <input class="block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 focus:border-purple-400 dark:border-gray-600 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700 mt-1" type="email" placeholder="john@doe.com"  v-model="form_add_user.email" required>
        <span class="text-xs">{{ $t('auth.email_privacy') }}</span>
        </label>
        <label class="block text-sm text-gray-700 dark:text-gray-400 mt-4">
        <span>{{ $t('auth.password') }}</span>
        <input class="block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 focus:border-purple-400 dark:border-gray-600 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700 mt-1" type="password" placeholder="***************" v-model="form_add_user.password" required>
        <span class="text-xs">{{ $t('auth.password_info') }}</span>
        </label>
        <label class="block text-sm text-gray-700 dark:text-gray-400 mt-4">
        <span>{{ $t('auth.password_confirm') }}</span>
        <input class="block w-full text-sm focus:outline-none dark:text-gray-300 form-input leading-5 focus:border-purple-400 dark:border-gray-600 focus:shadow-outline-purple dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700 mt-1" type="password" placeholder="***************" v-model="form_add_user.repassword" required>
        </label>
        ...
        <p class="mt-4">
            <a @click="type = 'login'" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="#">{{ $t('auth.you_already_have_an_account') }} {{ $t('auth.signin') }}</a>
        </p>
    </form>
