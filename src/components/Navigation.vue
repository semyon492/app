...
<nav class="top-0 inset-x-0 fixed bg-gray-50 h-14 z-30 transition-position w-screen lg:w-auto dark:bg-slate-800 xl:pl-60">
    <div class="flex lg:items-stretch xl:max-w-6xl xl:mx-auto">
        <div class="flex flex-1 items-stretch h-14">
            <router-link class="block lg:flex items-center relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-slate-400 hover:text-black py-2 px-3 lg:w-16 lg:justify-center" to="/">
