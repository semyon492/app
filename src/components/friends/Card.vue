            ...
            <div class="grid-cols-2 my-4 gap-1" v-for="(item, index) in friends">
              <div class="col-span-1 flex items-center gap-x-3 px-4 py-5">
                ...
                <div class="">
                  ...
                  <v-button v-if="item.id != user.id" class="px-3 sm:px-4 py-1 md:py-2 ml-auto hover:bg-[#3C4D63] bg-[#3C4D63]/50 transition-20 text-white rounded-md text-[14px] sm:text-base">Write message</v-button>
                </div>
                <v-button v-if="item.id != user.id" @click="add_friend(item.id)" class="px-3 sm:px-4 py-1 md:py-2 ml-auto hover:bg-[#3C4D63] bg-[#3C4D63]/50 transition-20 text-white rounded-md text-[14px] sm:text-base">Add friend</v-button>
              </div>
            </div>       
          </div>
        </div>
