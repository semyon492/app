							...
							<div class="col-12 col-lg-5 col-xl-3 border-end list-group">
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									...
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-5.jpg" class="rounded-circle me-1" alt="Michelle Bilodeau" width="40" height="40">
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									...
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-2.jpg" class="rounded-circle me-1" alt="Alexander Groves" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Alexander Groves
											<div class="small"><span class="fas fa-circle chat-online"></span> Online</div>
										</div>
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-3.jpg" class="rounded-circle me-1" alt="Kathie Burton" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Kathie Burton
											<div class="small"><span class="fas fa-circle chat-online"></span> Online</div>
										</div>
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-4.jpg" class="rounded-circle me-1" alt="Daisy Seger" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Daisy Seger
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-5.jpg" class="rounded-circle me-1" alt="Fiona Green" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Fiona Green
											<div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
										</div>
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-2.jpg" class="rounded-circle me-1" alt="Doris Wilder" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Doris Wilder
											<div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
										</div>
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-4.jpg" class="rounded-circle me-1" alt="Haley Kennedy" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Haley Kennedy
											<div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
										</div>
								...
								<a href="#" class="list-group-item list-group-item-action border-0">
									<div class="d-flex align-items-start">
										<img src="https://spark.bootlab.io/img/avatars/avatar-3.jpg" class="rounded-circle me-1" alt="Jennifer Chang" width="40" height="40">
										<div class="flex-grow-1 ms-3">
											Jennifer Chang
											<div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
										</div>
								...
								<div class="position-relative">
									<div class="chat-messages p-4">
										...
										<div class="chat-message-right pb-4">
											<div>
												<img src="https://spark.bootlab.io/img/avatars/avatar.jpg" class="rounded-circle me-1" alt="Chris Wood" width="40" height="40">
										...
										<div class="chat-message-left pb-4">
											...
											<div class="flex-shrink-1 bg-light rounded py-2 px-3 ms-3">
												<div class="fw-bold mb-1">Kathie Burton</div>
