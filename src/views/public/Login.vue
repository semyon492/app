  ...
  <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
    <div class="flex flex-col overflow-y-auto md:flex-row">
      <div class="h-32 md:h-auto md:w-1/2">
        <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="https://windmill-dashboard-react.vercel.app/static/media/login-office.72742c2e.jpeg" alt="Office">
        <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="https://windmill-dashboard-react.vercel.app/static/media/login-office-dark.cb4a995f.jpeg" alt="Office">
      </div>
      <main class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
        <form class="w-full" @submit.prevent="login">
          ...
          <p class="mt-1">
            <router-link class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" to="/register">{{ $t('auth.signup') }}</router-link>
          </p>
        </form>
      </main>
    </div>
