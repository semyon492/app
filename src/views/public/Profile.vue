      ...
      <div class="w-full max-w-full px-3 shrink-0 md:w-10/12 md:flex-0">
        <div
          ...
          <img class="w-full rounded-t-2xl"
               src="https://wowonder.fra1.cdn.digitaloceanspaces.com/upload/photos/d-cover.jpg?cache=0"
              ...
              <div class="mb-6 -mt-6 lg:mb-0 lg:-mt-16">
                <a href="javascript:;">
                  <img class="h-auto max-w-full border-2 border-white border-solid rounded-circle"
                       src="https://wowonder.fra1.cdn.digitaloceanspaces.com/upload/photos/d-avatar.jpg?cache=0"
                       alt="profile image">
                </a>
              </div>
            </div>
