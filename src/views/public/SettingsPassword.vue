            ...
            <div class="bg-white dark:bg-slate-900 lg:rounded-2xl">
              ...
              <div class="flex-1 p-6">
                <div class="mb-6 last:mb-0">
                  ...
                  <div class="">
                    <div class="relative">
                      <input name="password_current" autocomplete="current-password" required="" type="password"
                      ...
                      <span
                          class="inline-flex justify-center items-center w-10 h-12 absolute top-0 left-0 z-10 pointer-events-none text-gray-500 dark:text-slate-400">
                              ...
                              d="M21 13H14.4L19.1 17.7L17.7 19.1L13 14.4V21H11V14.3L6.3 19L4.9 17.6L9.4 13H3V11H9.6L4.9 6.3L6.3 4.9L11 9.6V3H13V9.4L17.6 4.8L19 6.3L14.3 11H21V13Z"></path>
											</svg>
										</span>
                    </div>
                  </div>
                ...
                <div class="mb-6 last:mb-0">
                  ...
                  <div class="">
                    <div class="relative">
                      <input name="password_confirmation" autocomplete="new-password" required="" type="password"
                             class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800 pl-10">
                      <span
                          class="inline-flex justify-center items-center w-10 h-12 absolute top-0 left-0 z-10 pointer-events-none text-gray-500 dark:text-slate-400">
											<svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
