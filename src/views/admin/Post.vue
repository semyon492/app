  ...
  <div class="post">
    <form class="big_view" v-if="big_view" @submit.prevent="post">
      <div class="big_view_image">
        ...
        <div class="choice">
          <img src="https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac-vert.jpg"
               @click="select_pic('https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac-vert.jpg')">
          <img src="https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac.jpg"
               @click="select_pic('https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac.jpg')">
          <img src="https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac-soleil.jpg"
               @click="select_pic('https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac-soleil.jpg')">
          <img src="https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac-geler.jpg"
               @click="select_pic('https://projetweb-romain-colin.s3.eu-west-3.amazonaws.com/foret-lac-geler.jpg')">
        </div>
        <button class="delete_img" @click="delete_image" v-if="this.image_gived()"><i class="fa-solid fa-x"></i>
        </button>
      </div>
