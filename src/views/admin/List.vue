  ...
  <div class="list_article">
    <table class="table_list">
      ...
      <tr v-for="(article) in list_article" v-bind:key="article.id">
        ...
        <td class="line_btn">
          <router-link :to="`/admin/edit/${article.id}`"><i class="fa-solid fa-pen-to-square"></i></router-link>
        </td>
        <td class="line_btn">
          <button v-on:click="delete_article(article.id)" class="list_btn"><i
              class="fa-solid fa-trash-can td_function"></i></button>
        </td>
      </tr>
      </tbody>
