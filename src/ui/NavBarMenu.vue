...
<template>
  <div class="flex-none items-stretch flex h-14 lg:hidden" @click="show = !show" >
    <div class="flex text-blue-600 hover:text-black py-2 px-3 items-center cursor-pointer dark:text-white dark:hover:text-slate-400">
...
<!-- Dropdown menu -->
  ...
  <div :class="show ? showOnList : showOffList" >
    <slot name="menu">
      <div v-if="user.is_connected" class="block lg:flex items-center relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-slate-400 hover:text-black lg:py-2 lg:px-3">
        <div class="flex items-center bg-gray-100 dark:bg-slate-800 lg:bg-transparent lg:dark:bg-transparent p-3 lg:p-0" @click="menu1 = !menu1">
        ...
        <div :class="menu1 ? menu1On : menu1Off" @click="menu1 = !menu1">
          <router-link to="/profile" class="block lg:flex items-center relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-slate-400 hover:text-black py-2 px-3">
          ...
          <router-link to="/settings" class="block lg:flex items-center relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-slate-400 hover:text-black py-2 px-3">
            <div class="flex items-center">
              <!---->
              <span class="inline-flex justify-center items-center w-6 h-6 transition-colors">
                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
          ...
          <router-link to="/chat" class="block lg:flex items-center relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-slate-400 hover:text-black py-2 px-3">
            <div class="flex items-center">
              <!---->
              <span class="inline-flex justify-center items-center w-6 h-6 transition-colors">
                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
